...
test_list = [
  {:logger, "def logger do ... end", [:utils]},
  {:utils, "def utils do ... end", []},
  {:main, "def main do ... end", [:logger, :utils]},
  {:helper, "def helper do ... end", [:main]}
]

sorted = CallGraphSorter.sort(test_list)
IO.inspect(sorted, label: "Sorted functions by dependencies")
